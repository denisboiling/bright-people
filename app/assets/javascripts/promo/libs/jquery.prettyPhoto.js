		...
		*/
		$.prettyPhoto.open = function(event) {
			...
			if(settings.social_tools){
			    ...
			    $('head').append('<meta property="og:site_name" content="Яркие Люди" /> \
                                              <meta property="og:title" content="Яркие Люди" /> \
                                              <meta property="og:url" content="' + location.href + '" /> \
                                              <meta property="og:image" content="' + social_image + '" /> \
                                              <meta property="og:type" content="non_profit" /> \
                                              <meta property="og:description" content="Яркие Люди"/>'
					    );
			    $('.pp_social div.count_view').append(views);
			    $('.pp_social div.download_pic a').attr({href: big, target: "_blank"});
			    ///////////////////////////////////////////////////////////////////
