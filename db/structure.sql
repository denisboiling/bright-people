...
--
-- Name: activity_direction_relations; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--

CREATE TABLE activity_direction_relations (
    id integer NOT NULL,
    activity_id integer,
    direction_tag_id integer,
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL
);
...
--
-- Name: activity_direction_relations_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE activity_direction_relations_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: activity_direction_relations_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE activity_direction_relations_id_seq OWNED BY activity_direction_relations.id;


--
-- Name: activity_photos; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
CREATE SEQUENCE activity_photos_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE activity_photos_id_seq OWNED BY activity_photos.id;


--
-- Name: activity_votes; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: activity_votes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE activity_votes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: activity_votes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE activity_votes_id_seq OWNED BY activity_votes.id;
...
--
-- Name: direction_tags_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE direction_tags_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: direction_tags_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE direction_tags_id_seq OWNED BY direction_tags.id;
...
--
-- Name: video_urls; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: video_urls_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE video_urls_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: video_urls_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE video_urls_id_seq OWNED BY video_urls.id;
...
ALTER TABLE ONLY activity_direction_relations ALTER COLUMN id SET DEFAULT nextval('activity_direction_relations_id_seq'::regclass);
...
ALTER TABLE ONLY activity_photos ALTER COLUMN id SET DEFAULT nextval('activity_photos_id_seq'::regclass);
...
ALTER TABLE ONLY activity_votes ALTER COLUMN id SET DEFAULT nextval('activity_votes_id_seq'::regclass);
...
--
-- Name: activity_direction_relations_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY activity_direction_relations
    ADD CONSTRAINT activity_direction_relations_pkey PRIMARY KEY (id);


--
-- Name: activity_photos_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY activity_photos
    ADD CONSTRAINT activity_photos_pkey PRIMARY KEY (id);


--
-- Name: activity_votes_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY activity_votes
    ADD CONSTRAINT activity_votes_pkey PRIMARY KEY (id);
...
--
-- Name: video_urls_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--
...
--
-- Name: index_users_on_odnoklassniki_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_users_on_odnoklassniki_id ON users USING btree (odnoklassniki_id);


--
-- Name: index_users_on_vkontakte_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE INDEX index_users_on_vkontakte_id ON users USING btree (vkontakte_id);
...
INSERT INTO schema_migrations (version) VALUES ('20120523082257');

INSERT INTO schema_migrations (version) VALUES ('20120523083451');

INSERT INTO schema_migrations (version) VALUES ('20120523091754');
